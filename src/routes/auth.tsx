      ...
      <main className="flex-1 px-4 py-8 max-w-md mx-auto w-full">
        ...
        <button
          ...
          onClick={async () => {
            ...
            if (result.redirected) return;
            if (result.error) setError(result.error.message ?? "Falha ao entrar com Apple");
          }}
          className="w-full bg-black text-white font-semibold py-3 rounded-full flex items-center justify-center gap-2 mb-4 hover:bg-black/90"
        >
