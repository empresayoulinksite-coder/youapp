...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Tesouro" },
      { name: "description", content: "Tudo o que você precisa em um só lugar!" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Tesouro" },
      { property: "og:description", content: "Tudo o que você precisa em um só lugar!" },
